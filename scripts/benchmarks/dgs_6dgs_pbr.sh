...
# Benchmark different modes and view-dependent configurations on Tanks & Temples PBR datasets
#
# Modes:
...
for dir in "$base_dir"*/; do
    if [ -d "$dir" ]; then
        ...
        output_dir="output/dgs/tandt_pbr/${scene_name}"
...
for config in "${configs[@]}"; do
    ...
    for dir in "$base_dir"*/; do
        if [ -d "$dir" ]; then
            ...
            output_dir="output/dgs-full_${config_name}/tandt_pbr/${scene_name}"
