	...
	bool* present)
{
	...
	float3 p_view;
	present[idx] = in_frustum_with_cutting_plane(idx, orig_points, viewmatrix, projmatrix, cov3D, false, x_threshold, p_view);
}
...
CudaRasterizer::GeometryState CudaRasterizer::GeometryState::fromChunk(char*& chunk, size_t P)
{
	...
	obtain(chunk, geom.cov3D_pre_cut, P * 6, 128);
