...
os.environ["TORCH_CUDA_ARCH_LIST"] = "8.6;8.9"  # RTX 30/40 series support
...
setup(
    name="tcgs_speedy_rasterizer",
    packages=['tcgs_speedy_rasterizer'],
    ext_modules=[
        CUDAExtension(
            name="tcgs_speedy_rasterizer._C",
            sources=[
